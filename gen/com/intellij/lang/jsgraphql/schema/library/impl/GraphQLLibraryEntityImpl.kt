...
internal class GraphQLLibraryEntityData : WorkspaceEntityData<GraphQLLibraryEntity>() {
  ...
  override fun newInstance(): GraphQLLibraryEntity = GraphQLLibraryEntityImpl(this)
  override fun newBuilderInstance(): ModifiableWorkspaceEntityBase<GraphQLLibraryEntity, *> = GraphQLLibraryEntityImpl.Builder(null)
